-- =========================================================================
-- DAİL GRUP — initial content seed
...
insert into about_content (id, title, description, mission, vision, values, timeline, management_message) values
  (1, 'Yılların Tecrübesi, Güvenin Adresi',
   'DAİL GRUP olarak gıda, içecek ve inşaat sektörlerinde edindiğimiz köklü tecrübeyi; güçlü bayilik ağımız, geniş lojistik kapasitemiz ve müşteri odaklı hizmet anlayışımızla birleştiriyoruz.',
   ...
   '[{"year":"Başlangıç","title":"Kuruluş","description":"Gıda bayiliği ile sektöre ilk adımımızı attık."},{"year":"Büyüme","title":"Portföy Genişlemesi","description":"İçecek grubu bayilikleri ve inşaat hizmetleri ile iş alanımızı genişlettik."},{"year":"Bugün","title":"DAİL GRUP","description":"8 bayilik ve inşaat hizmetleriyle bölgemizin güvenilir iş ortağı olduk."}]'::jsonb,
   'DAİL GRUP olarak kurulduğumuz günden bu yana temel önceliğimiz; iş ortaklarımıza güven veren, sürdürülebilir ve kaliteli bir hizmet sunmak oldu.')
on conflict (id) do update set
  title = excluded.title,
  description = excluded.description,
...
insert into contact_info (id, address, phone, whatsapp, email, map_embed_url, working_hours, social, footer_image) values
  (1, 'Güzelyurt, 26223 Sok No:22, 07112 Aksu/Antalya', '+90 532 651 18 30', '905326511830', 'info@dailgrup.com',
