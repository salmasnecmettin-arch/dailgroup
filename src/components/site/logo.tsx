...
/**
 * Typographic recreation of the DAİL GRUP wordmark using brand colors.
...
export function Logo({
  ...
  return (
    <span
      className={cn(
        "font-display inline-flex items-baseline gap-[6px] text-2xl font-extrabold tracking-tight",
        className,
      )}
    >
